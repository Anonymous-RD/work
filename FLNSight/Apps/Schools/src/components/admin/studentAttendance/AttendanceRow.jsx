...
export default function AttendanceRow({
  ...
  return (
    <div className="flex flex-col md:flex-row items-center md:justify-between w-full border-b py-5 text-sm">
      {/* Date Column */}
      <div className="w-full md:w-1/3 text-gray-800 font-medium">{studentname}</div>

      {/* Day Column */}
      <div className="w-full md:w-2/3 text-gray-500 font-medium">{rollno}</div>

      {/* Attendance Status */}
      <div className={`w-full md:w-2/3 font-semibold ${statusColor}`}>
        {status}
      </div>
