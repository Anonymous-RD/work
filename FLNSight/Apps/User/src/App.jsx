...
import SchoolAdmin from "./Pages/school_pages/SchoolAdmin";
import SchoolUsers from "./Pages/school_pages/SchoolUsers";
import SchoolInviteForm from "./Pages/school_pages/SchoolInviteForm";
import SchoolEditForm from "./Pages/school_pages/SchoolEditForm";
function App() {
  ...
  <Route path="/" element={<SchoolAdmin />}>
    ...
    <Route path="/schools/invite" element={<SchoolInviteForm />}></Route>
    <Route path="schools" element={<SchoolUsers />}></Route>
    <Route path="/schools/edit" element={<SchoolEditForm />}></Route>
    <Route path="*" element={<Error />} />
  </Route>
</Route>
      <Route element={<ProtectedRoute allowedRoles={["admin", "soumya"]} />}>
