...
const AssessmentsGrid = () => {
  ...
  useEffect(() => {
    setMetadata({ title: "FLN Monitoring", backPath: null }); // No back button
  }, [setMetadata]);
  ...
  const handleFlnModule = () => {
    // setIconState("icon");
    navigate("/Add-FLN-Module");
  };
