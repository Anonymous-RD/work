    ...
    <div className="p-6 pl-0 pt-0 max-w-10xl mx-auto overflow-y-auto">
      ...
      {showForm ? (
        <div className="overflow-y-auto mb-[100px]">
          ...
          <div className="flex flex-col items-center ">
            <div className="flex flex-col items-center px-11 pt-3 pb-4 max-w-full text-black rounded-xl border border-dashed border-neutral-100 w-[350px] max-md:px-5">
              ...
              <label className="text-sm leading-4 text-[#000000] px-12 py-3 mt-3 w-[250px] h-10 bg-lime-300 rounded-xl text-center justify-center cursor-pointer">
                Browse File
                <input
                  type="file"
                  accept=".csv"
        ...
        <div
          ...
          // }}
        >
          <form onSubmit={handleFormSubmit} className="space-y-6 w-[100%] min-w-[1024px] pb-[100px]">
