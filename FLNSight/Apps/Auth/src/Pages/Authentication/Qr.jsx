  ...
  return (
    <div className="h-screen bg-white overflow-hidden">
      <div className="flex flex-col lg:flex-row w-full h-full">
        {/* Left Section (Form) */}
        <div className="w-full lg:w-1/2 px-4 lg:px-12 xl:px-24 py-8 lg:py-8 flex items-center overflow-y-auto">
          <div className="w-full max-w-md mx-auto mb-auto">
            <div className="flex pb-8">
              <div className="flex items-center mb-14 ml-6">
                <img src={flnlogo} alt="FLN Logo" className="h-8 w-8 mr-3" />
                <h1 className="text-xl text-gray-800 font-bold">FLNsight</h1>
              </div>
            </div>
            <div className="">
              <p className=" pl-7 mb-4">
              ...
              <div className="flex flex-col w-full pl-[60px] ">
                <div className="flex flex-col flex-1 justify-center w-full text-sm font-medium ml-16 ">
                  <img
                    src={qrCode}
                    alt="QR Code"
                    className="max-w-[160px] sm:max-w-[160px] h-[150px] mb-3 border-[#DAE8F0] border-4 rounded-[10px]"
                  />
                </div>
