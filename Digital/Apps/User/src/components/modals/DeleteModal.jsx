          ...
          >
            <div className="text-center py-3">
              ...
              <button
                onClick={closeModal}
                type="button"
                className="text-white bg-[#003765] mr-10 hover:bg-orange-300 rounded-xl !outline-none  font-medium text-sm inline-flex items-center px-12 py-3 text-center"
              >
                No
              </button>
              <button
                ...
                type="button"
                className="text-white bg-[#003765] hover:bg-orange-300 rounded-xl font-medium text-sm inline-flex items-center px-12 py-3 text-center"
              >
