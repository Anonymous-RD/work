...
import "./App.css";
import AssessmentsGrid from "./Pages/admin_pages/Assessments";
function App() {
    ...
    <Routes>
      ...
      >
        <Route path="/admin" element={<Admin />}>
          <Route index element={<Navigate to="/admin/assessment" replace />} />
          {/* <Route path="dashboard" element={<Dashboard />}></Route> */}
          <Route path="assessment" element={<AssessmentsGrid />} />
